...
const PrivacyPolicy = () => {
    ...
    return (
        <div className="bg-ink-900 pt-32 pb-20">
            <div className="container mx-auto px-6 md:px-12 max-w-3xl">
                <h1 className="text-4xl md:text-5xl font-bold text-white mb-8">Gizlilik Politikası</h1>
                <p className="text-white/40 text-sm mb-12">Son güncelleme: 23 Nisan 2026</p>

                <div className="space-y-8 text-white/60 leading-relaxed">
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-3">1. Genel Bilgi</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-3">2. Toplanan Bilgiler</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-3">3. Çerezler (Cookies)</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-3">4. Verilerin Kullanımı</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-3">5. Üçüncü Taraflarla Paylaşım</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-3">6. Veri Güvenliği</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-3">7. Haklarınız</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-3">8. İletişim</h2>
