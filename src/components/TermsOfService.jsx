        ...
        <div className="bg-ink-900 pt-32 pb-20">
            <div className="container mx-auto px-6 md:px-12 max-w-3xl">
                ...
                <div className="space-y-8 text-white/60 leading-relaxed">
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-3">1. Kabul</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-3">2. Hizmet Tanımı</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-3">3. Fikri Mülkiyet</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-3">4. Sorumluluk Sınırı</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-3">5. Dış Bağlantılar</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-3">7. Uygulanacak Hukuk</h2>
