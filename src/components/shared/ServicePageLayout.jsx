 ...
 * ServicePageLayout
 *
 * Shared Creative Playground layout for every /hizmetler/* page.
                ...
                <div className="container mx-auto px-4 md:px-8 relative z-10">
                    <div className="max-w-4xl">
                        <motion.div
                            ...
                            className={`inline-block ${TONE_BG[tone]} border-2 border-ink-900 rounded-full px-4 py-1.5 mb-6 ${TONE_SHADOW[tone]}`}
                        >
                        ...
                        <motion.button
                            ...
                            className="mt-10 bg-ink-900 text-white font-black text-lg px-8 py-4 rounded-full shadow-sticker-sun border-2 border-ink-900"
                        >
                            {t('btn_offer')}
                        </motion.button>
                    </div>
                            ...
                            {steps.map((step, i) => {
                                ...
                                return (
                                    <motion.div
                                        ...
                                        whileHover={{ y: -6, rotate: 0 }}
                                        className={`bg-white border-2 border-ink-900 rounded-3xl p-7 ${TONE_SHADOW[stepTone]} ${tilt}`}
                                    >
                                        <div className={`w-12 h-12 ${TONE_BG[stepTone]} border-2 border-ink-900 rounded-xl flex items-center justify-center font-black text-sm text-ink-900 mb-4`}>
                                            {step.step}
                                        </div>
                ...
                <section className="py-20 md:py-28 bg-white">
                    <div className="container mx-auto px-4 md:px-8 max-w-4xl">
                        <div className="text-center mb-14">
                            <span className="inline-block bg-sun-200 border-2 border-ink-900 text-ink-900 font-black text-xs px-4 py-1.5 rounded-full mb-6 uppercase tracking-wider rotate-neg-1">
                                FAQ
                            </span>
                            <h2 className="text-4xl md:text-6xl font-black text-ink-900 leading-none tracking-tight">
                                {t('faq_title')}
            ...
            <section className="py-24 md:py-32 bg-ink-900 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 md:px-8 relative z-10 text-center max-w-4xl">
                    ...
                    <motion.button
                        ...
                        whileHover={{ scale: 1.05, y: -3 }}
                        whileTap={{ scale: 0.96 }}
                        className="inline-flex items-center gap-2 bg-sun-300 text-ink-900 font-black text-lg px-10 py-5 rounded-full border-2 border-ink-900 shadow-sticker-coral"
                    >
                        {t('btn_offer')}
...
const FAQItem = ({ question, answer, index }) => {
    ...
    return (
        <motion.div
            ...
            className={`bg-white border-2 border-ink-900 rounded-2xl overflow-hidden ${tones[index % tones.length]}`}
        >
            <button
