...
import { Palmtree, Home, PartyPopper, Film } from 'lucide-react';
...
const DroneCekim = () => {
    ...
    const content = isTr ? {
        ...
        features: [
            { icon: Palmtree, title: 'Turizm & otel', desc: 'Otel tesisi, plaj, havuz, manzara — tanıtım için birebir. KKTC\'nin en güzel hali.', tone: 'brand' },
            { icon: Home, title: 'Emlak & gayrimenkul', desc: 'Villa, apartman, site tanıtımı. Havadan görüntü satış ilanlarını 3x daha etkili yapar.', tone: 'coral' },
            { icon: PartyPopper, title: 'Etkinlik kaydı', desc: 'Düğün, konser, spor etkinliği — unutulmaz havadan sahneler.', tone: 'mint' },
            { icon: Film, title: 'Reklam filmi', desc: 'Sinematik havadan sekanslarla marka filmlerinize epik bir başlangıç.', tone: 'sun' },
        ],
        stats: [
        ...
        features: [
            { icon: Palmtree, title: 'Tourism & hotels', desc: "Hotel grounds, beaches, pools, views — perfect for promos. TRNC at its best.", tone: 'brand' },
            { icon: Home, title: 'Real estate', desc: 'Villa, apartment, complex promos. Aerial shots make listings 3x more effective.', tone: 'coral' },
            { icon: PartyPopper, title: 'Event capture', desc: 'Weddings, concerts, sports — unforgettable aerial moments.', tone: 'mint' },
            { icon: Film, title: 'Ad films', desc: 'Epic opening sequences for brand films with cinematic aerial shots.', tone: 'sun' },
        ],
        stats: [
