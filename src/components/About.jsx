                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <div className="rounded-2xl shadow-lg overflow-hidden">
                                <img src="/hf-workspace.webp" alt="BC Creative Agency modern çalışma ortamı, Girne KKTC" className="w-full h-auto object-cover" loading="lazy" width="640" height="480" />
                            </div>
                        </motion.div>
                    </div>
                </div>
