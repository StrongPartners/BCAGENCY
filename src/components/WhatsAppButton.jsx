...
/**
 * WhatsAppButton — Creative Playground floating CTA.
 * Sticker-style chunky border, auto-tooltip on first load,
 * wobble on hover.
 */
      ...
      {isVisible && (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
          ...
          >
            ...
            <svg viewBox="0 0 24 24" className="w-8 h-8 fill-ink-900 relative z-10">
