                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        <div className="space-y-5">
                            ...
                            <div className="bg-brand-600 rounded-xl p-6">
                                ...
                                <a href="https://wa.me/905488321919" target="_blank" rel="noopener noreferrer" className="inline-block bg-white text-ink-900 font-medium px-5 py-2 rounded-full hover:bg-ink-50 transition-colors">
