...
const Contact = () => {
    ...
    const channels = [
        ...
        {
            icon: (
                <svg viewBox="0 0 24 24" className="w-7 h-7 fill-none stroke-current stroke-2"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72 12.81 12.81 0 00.62 2.81 2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l2.27-2.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.62A2 2 0 0122 16.92z" /></svg>
            ),
        ...
        {
            icon: (
                <svg viewBox="0 0 24 24" className="w-7 h-7 fill-none stroke-current stroke-2"><path d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
            ),
                ...
                <div className="container mx-auto px-4 md:px-8 relative z-10 text-center">
                    ...
                    >
                        ...
                        <span className="relative inline-block">
                            <span className="relative z-10 text-coral-500">{t('contact_heading_accent')}</span>
                            <span className="absolute left-0 right-0 bottom-2 h-4 bg-sun-300 -z-0 rounded-sm" />
                        </span>
                    </motion.h1>
                    ...
                    <motion.p
                        ...
                        className="mt-8 text-lg md:text-xl text-ink-700 font-medium max-w-2xl mx-auto leading-relaxed"
                    >
                        {t('contact_sub')}
                    </motion.p>
                </div>
                        ...
                        {channels.map((ch, i) => (
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="text-ink-700 text-sm font-bold mb-0.5">{ch.label}</p>
                        ...
                        <div className="space-y-5">
                            ...
                            >
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 className="font-black text-ink-900 text-lg mb-2">{t('contact_address_label')}</h3>
                                        <p className="text-ink-700 font-medium leading-relaxed">{t('contact_address_val')}</p>
                                        <button
                                            onClick={() => window.open(t('contact_map_url'), '_blank')}
                                            className="mt-3 text-brand-600 font-black text-sm hover:underline"
                                        >
                                            {t('contact_maps_btn')}
                                        </button>
                                    </div>
                            ...
                            >
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 className="font-black text-ink-900 text-lg mb-2">{t('contact_hours_label')}</h3>
                                        <p className="text-ink-700 font-medium">{t('contact_hours_val')}</p>
                                    </div>
                                </div>
                            </motion.div>
