...
const FotografVideo = () => {
    ...
    const content = isTr ? {
        ...
        features: [
            ...
            { icon: '🍽️', title: 'Yemek & mekan', desc: "Restoran menüsü, menü fotoğrafları, mekan atmosfer çekimi — iştah açan görseller.", tone: 'sun' },
        ],
        stats: [
        ...
        features: [
            ...
            { icon: '🍽️', title: 'Food & venue', desc: "Restaurant menus, dish photography, venue atmosphere — mouth-watering shots.", tone: 'sun' },
        ],
        stats: [
    ...
    return <ServicePageLayout {...content} heroEmoji="📸" tone="mint" />;
};
