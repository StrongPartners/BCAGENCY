    ...
    return (
        <footer className="bg-[#0A0A0A] text-gray-400 py-16 text-sm">
            <div className="container mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                ...
                {/* Contact Column */}
                <div>
                    <h3 className="text-white text-lg font-bold mb-6">{t('footer_contact_title')}</h3>
                ...
                {/* Addresses Column */}
                <div>
                    <h3 className="text-white text-lg font-bold mb-6">{t('footer_address_title')}</h3>
                ...
                {/* Social Media Column */}
                <div>
                    <h3 className="text-white text-lg font-bold mb-6">{t('footer_social')}</h3>
